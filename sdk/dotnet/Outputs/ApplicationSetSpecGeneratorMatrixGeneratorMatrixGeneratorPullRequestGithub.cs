...
namespace Pulumi.Argocd.Outputs
{
    ...
    [OutputType]
    public sealed class ApplicationSetSpecGeneratorMatrixGeneratorMatrixGeneratorPullRequestGithub
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.ApplicationSetSpecGeneratorMatrixGeneratorMatrixGeneratorPullRequestGithubTokenRef? TokenRef;

        [OutputConstructor]
        private ApplicationSetSpecGeneratorMatrixGeneratorMatrixGeneratorPullRequestGithub(
            string? api,
            ...
            Outputs.ApplicationSetSpecGeneratorMatrixGeneratorMatrixGeneratorPullRequestGithubTokenRef? tokenRef)
        {
            Api = api;
