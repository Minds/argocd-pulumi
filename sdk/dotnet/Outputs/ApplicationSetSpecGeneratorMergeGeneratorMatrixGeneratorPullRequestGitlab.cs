...
namespace Pulumi.Argocd.Outputs
{
    ...
    [OutputType]
    public sealed class ApplicationSetSpecGeneratorMergeGeneratorMatrixGeneratorPullRequestGitlab
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.ApplicationSetSpecGeneratorMergeGeneratorMatrixGeneratorPullRequestGitlabTokenRef? TokenRef;

        [OutputConstructor]
        private ApplicationSetSpecGeneratorMergeGeneratorMatrixGeneratorPullRequestGitlab(
            string? api,
            ...
            Outputs.ApplicationSetSpecGeneratorMergeGeneratorMatrixGeneratorPullRequestGitlabTokenRef? tokenRef)
        {
            Api = api;
            Labels = labels;
            Project = project;
