...
namespace Pulumi.Argocd.Outputs
{
    ...
    [OutputType]
    public sealed class ApplicationSetSpecGeneratorPullRequestGithub
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.ApplicationSetSpecGeneratorPullRequestGithubTokenRef? TokenRef;

        [OutputConstructor]
        private ApplicationSetSpecGeneratorPullRequestGithub(
            string? api,
            ...
            Outputs.ApplicationSetSpecGeneratorPullRequestGithubTokenRef? tokenRef)
        {
            Api = api;
