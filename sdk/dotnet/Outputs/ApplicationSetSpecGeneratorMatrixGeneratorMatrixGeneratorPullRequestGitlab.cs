...
namespace Pulumi.Argocd.Outputs
{
    ...
    [OutputType]
    public sealed class ApplicationSetSpecGeneratorMatrixGeneratorMatrixGeneratorPullRequestGitlab
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.ApplicationSetSpecGeneratorMatrixGeneratorMatrixGeneratorPullRequestGitlabTokenRef? TokenRef;

        [OutputConstructor]
        private ApplicationSetSpecGeneratorMatrixGeneratorMatrixGeneratorPullRequestGitlab(
            string? api,
            ...
            Outputs.ApplicationSetSpecGeneratorMatrixGeneratorMatrixGeneratorPullRequestGitlabTokenRef? tokenRef)
        {
            Api = api;
            Labels = labels;
            Project = project;
