...
namespace Pulumi.Argocd.Outputs
{
    ...
    [OutputType]
    public sealed class ApplicationSetSpecGeneratorMatrixGeneratorPullRequestGithub
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.ApplicationSetSpecGeneratorMatrixGeneratorPullRequestGithubTokenRef? TokenRef;

        [OutputConstructor]
        private ApplicationSetSpecGeneratorMatrixGeneratorPullRequestGithub(
            string? api,
            ...
            Outputs.ApplicationSetSpecGeneratorMatrixGeneratorPullRequestGithubTokenRef? tokenRef)
        {
            Api = api;
