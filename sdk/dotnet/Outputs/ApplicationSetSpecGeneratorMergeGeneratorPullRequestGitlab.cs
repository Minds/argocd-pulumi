...
namespace Pulumi.Argocd.Outputs
{
    ...
    [OutputType]
    public sealed class ApplicationSetSpecGeneratorMergeGeneratorPullRequestGitlab
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.ApplicationSetSpecGeneratorMergeGeneratorPullRequestGitlabTokenRef? TokenRef;

        [OutputConstructor]
        private ApplicationSetSpecGeneratorMergeGeneratorPullRequestGitlab(
            string? api,
            ...
            Outputs.ApplicationSetSpecGeneratorMergeGeneratorPullRequestGitlabTokenRef? tokenRef)
        {
            Api = api;
            Labels = labels;
            Project = project;
