...
namespace Pulumi.Argocd.Outputs
{
    ...
    [OutputType]
    public sealed class ApplicationSetSpecGeneratorMergeGeneratorMergeGeneratorPullRequestGithub
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.ApplicationSetSpecGeneratorMergeGeneratorMergeGeneratorPullRequestGithubTokenRef? TokenRef;

        [OutputConstructor]
        private ApplicationSetSpecGeneratorMergeGeneratorMergeGeneratorPullRequestGithub(
            string? api,
            ...
            Outputs.ApplicationSetSpecGeneratorMergeGeneratorMergeGeneratorPullRequestGithubTokenRef? tokenRef)
        {
            Api = api;
