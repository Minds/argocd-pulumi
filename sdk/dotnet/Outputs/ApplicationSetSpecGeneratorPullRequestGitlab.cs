...
namespace Pulumi.Argocd.Outputs
{
    ...
    [OutputType]
    public sealed class ApplicationSetSpecGeneratorPullRequestGitlab
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.ApplicationSetSpecGeneratorPullRequestGitlabTokenRef? TokenRef;

        [OutputConstructor]
        private ApplicationSetSpecGeneratorPullRequestGitlab(
            string? api,
            ...
            Outputs.ApplicationSetSpecGeneratorPullRequestGitlabTokenRef? tokenRef)
        {
            Api = api;
            Labels = labels;
            Project = project;
