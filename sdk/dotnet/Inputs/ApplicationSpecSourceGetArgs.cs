...
namespace Pulumi.Argocd.Inputs
{
    ...
    public sealed class ApplicationSpecSourceGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("directory")]
        public Input<Inputs.ApplicationSpecSourceDirectoryGetArgs>? Directory { get; set; }

        /// <summary>
        /// Helm specific options.
        /// </summary>
        [Input("helm")]
        public Input<Inputs.ApplicationSpecSourceHelmGetArgs>? Helm { get; set; }

        /// <summary>
        /// Kustomize specific options.
        /// </summary>
        [Input("kustomize")]
        public Input<Inputs.ApplicationSpecSourceKustomizeGetArgs>? Kustomize { get; set; }
        ...
        /// </summary>
        [Input("plugin")]
        public Input<Inputs.ApplicationSpecSourcePluginGetArgs>? Plugin { get; set; }
        ...
        public ApplicationSpecSourceGetArgs()
        {
        }
        public static new ApplicationSpecSourceGetArgs Empty => new ApplicationSpecSourceGetArgs();
    }
}
