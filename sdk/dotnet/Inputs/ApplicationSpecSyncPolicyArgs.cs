...
namespace Pulumi.Argocd.Inputs
{
    ...
    public sealed class ApplicationSpecSyncPolicyArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Whether to automatically keep an application synced to the target revision.
        /// </summary>
        [Input("automated")]
        public Input<Inputs.ApplicationSpecSyncPolicyAutomatedArgs>? Automated { get; set; }

        /// <summary>
        /// Controls metadata in the given namespace (if `CreateNamespace=true`).
        /// </summary>
        [Input("managedNamespaceMetadata")]
        public Input<Inputs.ApplicationSpecSyncPolicyManagedNamespaceMetadataArgs>? ManagedNamespaceMetadata { get; set; }

        /// <summary>
        /// Controls failed sync retry behavior.
        /// </summary>
        [Input("retry")]
        public Input<Inputs.ApplicationSpecSyncPolicyRetryArgs>? Retry { get; set; }
