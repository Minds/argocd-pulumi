...
namespace Pulumi.Argocd.Inputs
{
    ...
    public sealed class ApplicationSetSpecGeneratorMergeTemplateSpecSourceGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("directory")]
        public Input<Inputs.ApplicationSetSpecGeneratorMergeTemplateSpecSourceDirectoryGetArgs>? Directory { get; set; }

        /// <summary>
        /// Helm specific options.
        /// </summary>
        [Input("helm")]
        public Input<Inputs.ApplicationSetSpecGeneratorMergeTemplateSpecSourceHelmGetArgs>? Helm { get; set; }

        /// <summary>
        /// Kustomize specific options.
        /// </summary>
        [Input("kustomize")]
        public Input<Inputs.ApplicationSetSpecGeneratorMergeTemplateSpecSourceKustomizeGetArgs>? Kustomize { get; set; }
        ...
        /// </summary>
        [Input("plugin")]
        public Input<Inputs.ApplicationSetSpecGeneratorMergeTemplateSpecSourcePluginGetArgs>? Plugin { get; set; }
        ...
        public ApplicationSetSpecGeneratorMergeTemplateSpecSourceGetArgs()
        {
        }
        public static new ApplicationSetSpecGeneratorMergeTemplateSpecSourceGetArgs Empty => new ApplicationSetSpecGeneratorMergeTemplateSpecSourceGetArgs();
    }
}
