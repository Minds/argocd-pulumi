...
namespace Pulumi.Argocd.Inputs
{
    ...
    public sealed class ApplicationSetSpecGeneratorScmProviderTemplateSpecSourceArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("directory")]
        public Input<Inputs.ApplicationSetSpecGeneratorScmProviderTemplateSpecSourceDirectoryArgs>? Directory { get; set; }

        /// <summary>
        /// Helm specific options.
        /// </summary>
        [Input("helm")]
        public Input<Inputs.ApplicationSetSpecGeneratorScmProviderTemplateSpecSourceHelmArgs>? Helm { get; set; }

        /// <summary>
        /// Kustomize specific options.
        /// </summary>
        [Input("kustomize")]
        public Input<Inputs.ApplicationSetSpecGeneratorScmProviderTemplateSpecSourceKustomizeArgs>? Kustomize { get; set; }
        ...
        /// </summary>
        [Input("plugin")]
        public Input<Inputs.ApplicationSetSpecGeneratorScmProviderTemplateSpecSourcePluginArgs>? Plugin { get; set; }
        ...
        public ApplicationSetSpecGeneratorScmProviderTemplateSpecSourceArgs()
        {
        }
        public static new ApplicationSetSpecGeneratorScmProviderTemplateSpecSourceArgs Empty => new ApplicationSetSpecGeneratorScmProviderTemplateSpecSourceArgs();
    }
}
