...
namespace Pulumi.Argocd.Inputs
{
    ...
    public sealed class ApplicationSetSpecGeneratorMatrixTemplateSpecSourceGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("directory")]
        public Input<Inputs.ApplicationSetSpecGeneratorMatrixTemplateSpecSourceDirectoryGetArgs>? Directory { get; set; }

        /// <summary>
        /// Helm specific options.
        /// </summary>
        [Input("helm")]
        public Input<Inputs.ApplicationSetSpecGeneratorMatrixTemplateSpecSourceHelmGetArgs>? Helm { get; set; }

        /// <summary>
        /// Kustomize specific options.
        /// </summary>
        [Input("kustomize")]
        public Input<Inputs.ApplicationSetSpecGeneratorMatrixTemplateSpecSourceKustomizeGetArgs>? Kustomize { get; set; }
        ...
        /// </summary>
        [Input("plugin")]
        public Input<Inputs.ApplicationSetSpecGeneratorMatrixTemplateSpecSourcePluginGetArgs>? Plugin { get; set; }
        ...
        public ApplicationSetSpecGeneratorMatrixTemplateSpecSourceGetArgs()
        {
        }
        public static new ApplicationSetSpecGeneratorMatrixTemplateSpecSourceGetArgs Empty => new ApplicationSetSpecGeneratorMatrixTemplateSpecSourceGetArgs();
    }
}
