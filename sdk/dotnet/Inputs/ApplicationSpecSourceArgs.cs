...
namespace Pulumi.Argocd.Inputs
{
    ...
    public sealed class ApplicationSpecSourceArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("directory")]
        public Input<Inputs.ApplicationSpecSourceDirectoryArgs>? Directory { get; set; }

        /// <summary>
        /// Helm specific options.
        /// </summary>
        [Input("helm")]
        public Input<Inputs.ApplicationSpecSourceHelmArgs>? Helm { get; set; }

        /// <summary>
        /// Kustomize specific options.
        /// </summary>
        [Input("kustomize")]
        public Input<Inputs.ApplicationSpecSourceKustomizeArgs>? Kustomize { get; set; }
        ...
        /// </summary>
        [Input("plugin")]
        public Input<Inputs.ApplicationSpecSourcePluginArgs>? Plugin { get; set; }
        ...
        public ApplicationSpecSourceArgs()
        {
        }
        public static new ApplicationSpecSourceArgs Empty => new ApplicationSpecSourceArgs();
    }
}
