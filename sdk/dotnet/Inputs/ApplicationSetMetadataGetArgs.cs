...
namespace Pulumi.Argocd.Inputs
{
    ...
    public sealed class ApplicationSetMetadataGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("annotations")]
        ...
        public ApplicationSetMetadataGetArgs()
        {
        }
        public static new ApplicationSetMetadataGetArgs Empty => new ApplicationSetMetadataGetArgs();
    }
}
