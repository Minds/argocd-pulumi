...
namespace Pulumi.Argocd.Inputs
{
    ...
    public sealed class ApplicationSetSpecGeneratorClusterTemplateSpecSourceGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("directory")]
        public Input<Inputs.ApplicationSetSpecGeneratorClusterTemplateSpecSourceDirectoryGetArgs>? Directory { get; set; }

        /// <summary>
        /// Helm specific options.
        /// </summary>
        [Input("helm")]
        public Input<Inputs.ApplicationSetSpecGeneratorClusterTemplateSpecSourceHelmGetArgs>? Helm { get; set; }

        /// <summary>
        /// Kustomize specific options.
        /// </summary>
        [Input("kustomize")]
        public Input<Inputs.ApplicationSetSpecGeneratorClusterTemplateSpecSourceKustomizeGetArgs>? Kustomize { get; set; }
        ...
        /// </summary>
        [Input("plugin")]
        public Input<Inputs.ApplicationSetSpecGeneratorClusterTemplateSpecSourcePluginGetArgs>? Plugin { get; set; }
        ...
        public ApplicationSetSpecGeneratorClusterTemplateSpecSourceGetArgs()
        {
        }
        public static new ApplicationSetSpecGeneratorClusterTemplateSpecSourceGetArgs Empty => new ApplicationSetSpecGeneratorClusterTemplateSpecSourceGetArgs();
    }
}
