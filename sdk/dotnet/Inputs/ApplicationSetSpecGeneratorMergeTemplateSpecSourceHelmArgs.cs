...
namespace Pulumi.Argocd.Inputs
{
    ...
    public sealed class ApplicationSetSpecGeneratorMergeTemplateSpecSourceHelmArgs : global::Pulumi.ResourceArgs
    {
        [Input("fileParameters")]
        private InputList<Inputs.ApplicationSetSpecGeneratorMergeTemplateSpecSourceHelmFileParameterArgs>? _fileParameters;

        /// <summary>
        /// File parameters for the helm template.
        /// </summary>
        public InputList<Inputs.ApplicationSetSpecGeneratorMergeTemplateSpecSourceHelmFileParameterArgs> FileParameters
        {
            get => _fileParameters ?? (_fileParameters = new InputList<Inputs.ApplicationSetSpecGeneratorMergeTemplateSpecSourceHelmFileParameterArgs>());
        ...
        [Input("parameters")]
        private InputList<Inputs.ApplicationSetSpecGeneratorMergeTemplateSpecSourceHelmParameterArgs>? _parameters;

        /// <summary>
        /// Helm parameters which are passed to the helm template command upon manifest generation.
        /// </summary>
        public InputList<Inputs.ApplicationSetSpecGeneratorMergeTemplateSpecSourceHelmParameterArgs> Parameters
        {
            get => _parameters ?? (_parameters = new InputList<Inputs.ApplicationSetSpecGeneratorMergeTemplateSpecSourceHelmParameterArgs>());
        ...
        public ApplicationSetSpecGeneratorMergeTemplateSpecSourceHelmArgs()
        {
        }
        public static new ApplicationSetSpecGeneratorMergeTemplateSpecSourceHelmArgs Empty => new ApplicationSetSpecGeneratorMergeTemplateSpecSourceHelmArgs();
    }
}
