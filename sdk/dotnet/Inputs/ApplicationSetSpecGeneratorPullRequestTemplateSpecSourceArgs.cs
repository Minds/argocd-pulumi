...
namespace Pulumi.Argocd.Inputs
{
    ...
    public sealed class ApplicationSetSpecGeneratorPullRequestTemplateSpecSourceArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("directory")]
        public Input<Inputs.ApplicationSetSpecGeneratorPullRequestTemplateSpecSourceDirectoryArgs>? Directory { get; set; }

        /// <summary>
        /// Helm specific options.
        /// </summary>
        [Input("helm")]
        public Input<Inputs.ApplicationSetSpecGeneratorPullRequestTemplateSpecSourceHelmArgs>? Helm { get; set; }

        /// <summary>
        /// Kustomize specific options.
        /// </summary>
        [Input("kustomize")]
        public Input<Inputs.ApplicationSetSpecGeneratorPullRequestTemplateSpecSourceKustomizeArgs>? Kustomize { get; set; }
        ...
        /// </summary>
        [Input("plugin")]
        public Input<Inputs.ApplicationSetSpecGeneratorPullRequestTemplateSpecSourcePluginArgs>? Plugin { get; set; }
        ...
        public ApplicationSetSpecGeneratorPullRequestTemplateSpecSourceArgs()
        {
        }
        public static new ApplicationSetSpecGeneratorPullRequestTemplateSpecSourceArgs Empty => new ApplicationSetSpecGeneratorPullRequestTemplateSpecSourceArgs();
    }
}
