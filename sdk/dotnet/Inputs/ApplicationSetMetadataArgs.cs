...
namespace Pulumi.Argocd.Inputs
{
    ...
    public sealed class ApplicationSetMetadataArgs : global::Pulumi.ResourceArgs
    {
        [Input("annotations")]
        ...
        public ApplicationSetMetadataArgs()
        {
        }
        public static new ApplicationSetMetadataArgs Empty => new ApplicationSetMetadataArgs();
    }
}
