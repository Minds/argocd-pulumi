...
namespace Pulumi.Argocd.Inputs
{
    ...
    public sealed class ApplicationSetSpecGeneratorListTemplateSpecSourceArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("directory")]
        public Input<Inputs.ApplicationSetSpecGeneratorListTemplateSpecSourceDirectoryArgs>? Directory { get; set; }

        /// <summary>
        /// Helm specific options.
        /// </summary>
        [Input("helm")]
        public Input<Inputs.ApplicationSetSpecGeneratorListTemplateSpecSourceHelmArgs>? Helm { get; set; }

        /// <summary>
        /// Kustomize specific options.
        /// </summary>
        [Input("kustomize")]
        public Input<Inputs.ApplicationSetSpecGeneratorListTemplateSpecSourceKustomizeArgs>? Kustomize { get; set; }
        ...
        /// </summary>
        [Input("plugin")]
        public Input<Inputs.ApplicationSetSpecGeneratorListTemplateSpecSourcePluginArgs>? Plugin { get; set; }
        ...
        public ApplicationSetSpecGeneratorListTemplateSpecSourceArgs()
        {
        }
        public static new ApplicationSetSpecGeneratorListTemplateSpecSourceArgs Empty => new ApplicationSetSpecGeneratorListTemplateSpecSourceArgs();
    }
}
