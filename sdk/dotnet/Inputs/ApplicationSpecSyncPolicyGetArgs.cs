...
namespace Pulumi.Argocd.Inputs
{
    ...
    public sealed class ApplicationSpecSyncPolicyGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Whether to automatically keep an application synced to the target revision.
        /// </summary>
        [Input("automated")]
        public Input<Inputs.ApplicationSpecSyncPolicyAutomatedGetArgs>? Automated { get; set; }

        /// <summary>
        /// Controls metadata in the given namespace (if `CreateNamespace=true`).
        /// </summary>
        [Input("managedNamespaceMetadata")]
        public Input<Inputs.ApplicationSpecSyncPolicyManagedNamespaceMetadataGetArgs>? ManagedNamespaceMetadata { get; set; }

        /// <summary>
        /// Controls failed sync retry behavior.
        /// </summary>
        [Input("retry")]
        public Input<Inputs.ApplicationSpecSyncPolicyRetryGetArgs>? Retry { get; set; }
        ...
        public ApplicationSpecSyncPolicyGetArgs()
        {
        }
        public static new ApplicationSpecSyncPolicyGetArgs Empty => new ApplicationSpecSyncPolicyGetArgs();
    }
}
