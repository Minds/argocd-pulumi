...
namespace Pulumi.Argocd.Inputs
{
    ...
    public sealed class ApplicationSetSpecGeneratorGitTemplateSpecSourceHelmArgs : global::Pulumi.ResourceArgs
    {
        [Input("fileParameters")]
        private InputList<Inputs.ApplicationSetSpecGeneratorGitTemplateSpecSourceHelmFileParameterArgs>? _fileParameters;

        /// <summary>
        /// File parameters for the helm template.
        /// </summary>
        public InputList<Inputs.ApplicationSetSpecGeneratorGitTemplateSpecSourceHelmFileParameterArgs> FileParameters
        {
            get => _fileParameters ?? (_fileParameters = new InputList<Inputs.ApplicationSetSpecGeneratorGitTemplateSpecSourceHelmFileParameterArgs>());
        ...
        [Input("parameters")]
        private InputList<Inputs.ApplicationSetSpecGeneratorGitTemplateSpecSourceHelmParameterArgs>? _parameters;

        /// <summary>
        /// Helm parameters which are passed to the helm template command upon manifest generation.
        /// </summary>
        public InputList<Inputs.ApplicationSetSpecGeneratorGitTemplateSpecSourceHelmParameterArgs> Parameters
        {
            get => _parameters ?? (_parameters = new InputList<Inputs.ApplicationSetSpecGeneratorGitTemplateSpecSourceHelmParameterArgs>());
        ...
        public ApplicationSetSpecGeneratorGitTemplateSpecSourceHelmArgs()
        {
        }
        public static new ApplicationSetSpecGeneratorGitTemplateSpecSourceHelmArgs Empty => new ApplicationSetSpecGeneratorGitTemplateSpecSourceHelmArgs();
    }
}
