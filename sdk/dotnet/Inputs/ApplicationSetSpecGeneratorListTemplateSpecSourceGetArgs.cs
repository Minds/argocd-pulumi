...
namespace Pulumi.Argocd.Inputs
{
    ...
    public sealed class ApplicationSetSpecGeneratorListTemplateSpecSourceGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("directory")]
        public Input<Inputs.ApplicationSetSpecGeneratorListTemplateSpecSourceDirectoryGetArgs>? Directory { get; set; }

        /// <summary>
        /// Helm specific options.
        /// </summary>
        [Input("helm")]
        public Input<Inputs.ApplicationSetSpecGeneratorListTemplateSpecSourceHelmGetArgs>? Helm { get; set; }

        /// <summary>
        /// Kustomize specific options.
        /// </summary>
        [Input("kustomize")]
        public Input<Inputs.ApplicationSetSpecGeneratorListTemplateSpecSourceKustomizeGetArgs>? Kustomize { get; set; }
        ...
        /// </summary>
        [Input("plugin")]
        public Input<Inputs.ApplicationSetSpecGeneratorListTemplateSpecSourcePluginGetArgs>? Plugin { get; set; }
        ...
        public ApplicationSetSpecGeneratorListTemplateSpecSourceGetArgs()
        {
        }
        public static new ApplicationSetSpecGeneratorListTemplateSpecSourceGetArgs Empty => new ApplicationSetSpecGeneratorListTemplateSpecSourceGetArgs();
    }
}
