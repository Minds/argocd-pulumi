...
namespace Pulumi.Argocd.Inputs
{
    ...
    public sealed class ApplicationSetSpecGeneratorScmProviderTemplateSpecSourceGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("directory")]
        public Input<Inputs.ApplicationSetSpecGeneratorScmProviderTemplateSpecSourceDirectoryGetArgs>? Directory { get; set; }

        /// <summary>
        /// Helm specific options.
        /// </summary>
        [Input("helm")]
        public Input<Inputs.ApplicationSetSpecGeneratorScmProviderTemplateSpecSourceHelmGetArgs>? Helm { get; set; }

        /// <summary>
        /// Kustomize specific options.
        /// </summary>
        [Input("kustomize")]
        public Input<Inputs.ApplicationSetSpecGeneratorScmProviderTemplateSpecSourceKustomizeGetArgs>? Kustomize { get; set; }
        ...
        /// </summary>
        [Input("plugin")]
        public Input<Inputs.ApplicationSetSpecGeneratorScmProviderTemplateSpecSourcePluginGetArgs>? Plugin { get; set; }
        ...
        public ApplicationSetSpecGeneratorScmProviderTemplateSpecSourceGetArgs()
        {
        }
        public static new ApplicationSetSpecGeneratorScmProviderTemplateSpecSourceGetArgs Empty => new ApplicationSetSpecGeneratorScmProviderTemplateSpecSourceGetArgs();
    }
}
