...
namespace Pulumi.Argocd.Inputs
{
    ...
    public sealed class ApplicationSetSpecTemplateSpecSourceHelmArgs : global::Pulumi.ResourceArgs
    {
        [Input("fileParameters")]
        private InputList<Inputs.ApplicationSetSpecTemplateSpecSourceHelmFileParameterArgs>? _fileParameters;

        /// <summary>
        /// File parameters for the helm template.
        /// </summary>
        public InputList<Inputs.ApplicationSetSpecTemplateSpecSourceHelmFileParameterArgs> FileParameters
        {
            get => _fileParameters ?? (_fileParameters = new InputList<Inputs.ApplicationSetSpecTemplateSpecSourceHelmFileParameterArgs>());
        ...
        [Input("parameters")]
        private InputList<Inputs.ApplicationSetSpecTemplateSpecSourceHelmParameterArgs>? _parameters;

        /// <summary>
        /// Helm parameters which are passed to the helm template command upon manifest generation.
        /// </summary>
        public InputList<Inputs.ApplicationSetSpecTemplateSpecSourceHelmParameterArgs> Parameters
        {
            get => _parameters ?? (_parameters = new InputList<Inputs.ApplicationSetSpecTemplateSpecSourceHelmParameterArgs>());
        ...
        public ApplicationSetSpecTemplateSpecSourceHelmArgs()
        {
        }
        public static new ApplicationSetSpecTemplateSpecSourceHelmArgs Empty => new ApplicationSetSpecTemplateSpecSourceHelmArgs();
    }
}
