...
namespace Pulumi.Argocd.Inputs
{
    ...
    public sealed class ApplicationSpecSourceHelmGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("fileParameters")]
        private InputList<Inputs.ApplicationSpecSourceHelmFileParameterGetArgs>? _fileParameters;

        /// <summary>
        /// File parameters for the helm template.
        /// </summary>
        public InputList<Inputs.ApplicationSpecSourceHelmFileParameterGetArgs> FileParameters
        {
            get => _fileParameters ?? (_fileParameters = new InputList<Inputs.ApplicationSpecSourceHelmFileParameterGetArgs>());
        ...
        [Input("parameters")]
        private InputList<Inputs.ApplicationSpecSourceHelmParameterGetArgs>? _parameters;

        /// <summary>
        /// Helm parameters which are passed to the helm template command upon manifest generation.
        /// </summary>
        public InputList<Inputs.ApplicationSpecSourceHelmParameterGetArgs> Parameters
        {
            get => _parameters ?? (_parameters = new InputList<Inputs.ApplicationSpecSourceHelmParameterGetArgs>());
        ...
        public ApplicationSpecSourceHelmGetArgs()
        {
        }
        public static new ApplicationSpecSourceHelmGetArgs Empty => new ApplicationSpecSourceHelmGetArgs();
    }
}
