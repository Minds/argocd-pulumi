...
namespace Pulumi.Argocd.Inputs
{
    ...
    public sealed class ApplicationSetSpecGeneratorClusterTemplateSpecSourceArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("directory")]
        public Input<Inputs.ApplicationSetSpecGeneratorClusterTemplateSpecSourceDirectoryArgs>? Directory { get; set; }

        /// <summary>
        /// Helm specific options.
        /// </summary>
        [Input("helm")]
        public Input<Inputs.ApplicationSetSpecGeneratorClusterTemplateSpecSourceHelmArgs>? Helm { get; set; }

        /// <summary>
        /// Kustomize specific options.
        /// </summary>
        [Input("kustomize")]
        public Input<Inputs.ApplicationSetSpecGeneratorClusterTemplateSpecSourceKustomizeArgs>? Kustomize { get; set; }
        ...
        /// </summary>
        [Input("plugin")]
        public Input<Inputs.ApplicationSetSpecGeneratorClusterTemplateSpecSourcePluginArgs>? Plugin { get; set; }
        ...
        public ApplicationSetSpecGeneratorClusterTemplateSpecSourceArgs()
        {
        }
        public static new ApplicationSetSpecGeneratorClusterTemplateSpecSourceArgs Empty => new ApplicationSetSpecGeneratorClusterTemplateSpecSourceArgs();
    }
}
