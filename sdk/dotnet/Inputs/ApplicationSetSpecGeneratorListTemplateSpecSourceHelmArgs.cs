...
namespace Pulumi.Argocd.Inputs
{
    ...
    public sealed class ApplicationSetSpecGeneratorListTemplateSpecSourceHelmArgs : global::Pulumi.ResourceArgs
    {
        [Input("fileParameters")]
        private InputList<Inputs.ApplicationSetSpecGeneratorListTemplateSpecSourceHelmFileParameterArgs>? _fileParameters;

        /// <summary>
        /// File parameters for the helm template.
        /// </summary>
        public InputList<Inputs.ApplicationSetSpecGeneratorListTemplateSpecSourceHelmFileParameterArgs> FileParameters
        {
            get => _fileParameters ?? (_fileParameters = new InputList<Inputs.ApplicationSetSpecGeneratorListTemplateSpecSourceHelmFileParameterArgs>());
        ...
        [Input("parameters")]
        private InputList<Inputs.ApplicationSetSpecGeneratorListTemplateSpecSourceHelmParameterArgs>? _parameters;

        /// <summary>
        /// Helm parameters which are passed to the helm template command upon manifest generation.
        /// </summary>
        public InputList<Inputs.ApplicationSetSpecGeneratorListTemplateSpecSourceHelmParameterArgs> Parameters
        {
            get => _parameters ?? (_parameters = new InputList<Inputs.ApplicationSetSpecGeneratorListTemplateSpecSourceHelmParameterArgs>());
        ...
        public ApplicationSetSpecGeneratorListTemplateSpecSourceHelmArgs()
        {
        }
        public static new ApplicationSetSpecGeneratorListTemplateSpecSourceHelmArgs Empty => new ApplicationSetSpecGeneratorListTemplateSpecSourceHelmArgs();
    }
}
